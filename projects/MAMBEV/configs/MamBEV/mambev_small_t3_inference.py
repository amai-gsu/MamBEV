...
train_cfg = dict(type="EpochBasedTrainLoop", max_epochs=total_epochs, val_interval=38)
...
val_evaluator = dict(
    ...
    # jsonfile_prefix="eval/r101_vis_3frame/",
...
#             init_kwargs=dict(project="tools-ICML_BEV", name="3-Frame Small"),
