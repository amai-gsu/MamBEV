"""
Some potential issues with input in forward pass and potential problems when no
previous BEV query is available but I think thats handled OK
"""
...
class ResNetFusion(BaseModule):
    ...
    def forward(self, x: tuple[torch.Tensor, ...]):
        x: torch.Tensor = torch.cat(x, 1).contiguous()
