...
from mmengine.hooks import CheckpointHook as BaseDistEvalHook
import mmengine

# from mmengine.hooks import EvalHook
from torch.nn.modules.batchnorm import _BatchNorm
# from mmdet.engine.hooks.checkloss_hook


def _calc_dynamic_intervals(start_interval, dynamic_interval_list):
    assert mmengine.is_list_of(dynamic_interval_list, tuple)
