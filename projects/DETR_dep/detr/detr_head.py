...
class DETRHead(AnchorFreeHead):
    ...
    <https://arxiv.org/pdf/.12872>`_ for details.
    ...
    def forward(
        self, x: Tuple[Tensor], batch_img_metas: List[dict]
    ...
    def forward_single(
        self, x: Tensor, batch_img_metas: List[dict]
    ) -> Tuple[Tensor, Tensor]:
    ...
    def loss_by_feat(
        ...
        assert (
            batch_gt_instances_ignore is None
    ...
    def predict(
        self, x: Tuple[Tensor], batch_data_samples: SampleList, rescale: bool = True
    ) -> InstanceList:
