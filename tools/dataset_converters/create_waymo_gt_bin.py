...
if __name__ == "__main__":
    ...
    if args.backend == "petrel":
        file_client_args = dict(
            backend="petrel",
            path_mapping=dict(
                {
                    "./data/waymo/": "s3://openmmlab/datasets/detection3d/waymo-v1.3.1/",
                    "data/waymo/": "s3://openmmlab/datasets/detection3d/waymo-v1.3.1/",
                }
            ),
        )
    else:  # args.backend == "disk":
    ...
    progress_bar = mmengine.ProgressBar(len(tfrecord_pathnames))
